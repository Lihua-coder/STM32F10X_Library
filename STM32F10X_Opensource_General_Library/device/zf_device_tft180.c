...
{
#if TFT180_USE_SOFT_SPI
    soft_spi_init(&tft180_spi, (uint8)0, (uint32)TFT180_SOFT_SPI_DELAY, (gpio_pin_enum)TFT180_SCL_PIN, (gpio_pin_enum)TFT180_SDA_PIN, (gpio_pin_enum)SOFT_SPI_PIN_NULL, (gpio_pin_enum)SOFT_SPI_PIN_NULL);
#else
...
//    gpio_init(TFT180_BL_PIN, GPO, GPIO_HIGH, GPO_PUSH_PULL);
    gpio_init(TFT180_DC_PIN, GPO_PUSH_PULL, 0);
    gpio_init(TFT180_RES_PIN, GPO_PUSH_PULL, 0);
    gpio_init(TFT180_CS_PIN, GPO_PUSH_PULL, 1);
    gpio_init(TFT180_BL_PIN, GPO_PUSH_PULL, 1);
